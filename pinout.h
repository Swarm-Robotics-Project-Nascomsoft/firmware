...
// All values below marked "TODO" are placeholders only, so the rewritten modules compile
// today. NONE of these have been confirmed against actual ESP32 DevKit/NodeMCU wiring yet -
// that happens tomorrow once boards are on the breadboard. Do not flash to real hardware
// using these values without updating them first.
// =====================================================================================
